<?php
  ...
  class Barang extends CI_Controller {
    ...
    public function simpan_barang()
    {
      ...
      $this->form_validation->set_rules('stok', 'Stok','trim|required', array('required' => 'stok harus diisi'));
      $this->form_validation->set_rules('id_kategori', 'Id Kategori','trim|required', array('required' => 'id kategori harus diisi'));

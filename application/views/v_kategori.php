      ...
      <div class="header">
        <div class="row clearfix">
          <div class="col-xs-12 col-sm-6">
            <h1 style="text-align:left;margin-left:400px;margin-top:100px;">Kategori</h1>
          </div>
        </div>
        <div class="body">
          <div class="row" style="width:850px; height:50px;margin-left:400px;margin-top:px;">
            <a style="margin: 35px;margin-left: 1px;background:#64c3c2;" href="#tambah"class="btn btn-primary" data-toggle="modal">
